...
$(document).ready(function(){
	$('.ua').click(function(){
		...
		$('.about-me__paragraph_3').html('"рішучий, розсудливий, добрий" + скріншот <img src="https://i.imgur.com/4cUQxfD.png" height="250" border="10" img="">')
	...
	$('.ru').click(function(){
		...
		$('.about-me__paragraph_3').html('"решительный, рассудительный, добрый" + скриншот <img src="https://i.imgur.com/4cUQxfD.png" height="250" border="10" img="">')
