...
$(document).ready(function(){
	$('.ua').click(function(){
		...
		$('.about-me__paragraph_3').html('"рішучий, розсудливий, добрий" + скріншот https://imgur.com/a/Fr0KNHB')
	...
	$('.ru').click(function(){
		...
		$('.about-me__paragraph_3').html('"решительный, рассудительный, добрый" + скриншот https://imgur.com/a/Fr0KNHB')
