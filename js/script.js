...
$(document).ready(function(){
	$('.ua').click(function(){
		...
		$('.about-me__paragraph_3').html('"рішучий, розсудливий, добрий" + скріншот <a href = "https://imgur.com/a/Fr0KNHB" style = "color: #ADAEAC; text-decoration: underline;" target = "_blank"> https://imgur.com/a/Fr0KNHB </a>')
	...
	$('.ru').click(function(){
		...
		$('.about-me__paragraph_1').html('Привет! Мой ник - Сом, мне 17 лет.')
		...
		$('.about-me__paragraph_3').html('"решительный, рассудительный, добрый" + скриншот <a href = "https://imgur.com/a/Fr0KNHB" style = "color: #ADAEAC; text-decoration: underline;" target = "_blank"> https://imgur.com/a/Fr0KNHB </a>')
